...
//String car_cascade_name = "/Users/ymy/Desktop/UIUC/cas2.xml";//UIUC
  String car_cascade_name = "../data/cars.xml";
...
int main() {
    ...
    VideoCapture cap("../data/video-01.avi");//汽车正面检测 for video processing
    Mat frame;
...
void detectAndDisplay( Mat frame )
{
    ...
    car_cascade.detectMultiScale( frame_gray, cars, 1.1, 1, 0|2, Size(30, 30) );
